...
public class AnagramSolver {
   ...
   */
    public void print(String text, int max){
        ...
        explore(smallDictionary, target, new ArrayList<String>(),max);
    }
    ...
    private void explore(List<String> smallDictionary, LetterInventory target, 
                    List<String> currentWords, int max){
        if (target.isEmpty()){
            ...
            for (String word : smallDictionary){
                ...
                if (subtracted != null){
                    ...
                    //System.out.println(currentWords);
                    if (currentWords.size()-1 < max){
                       explore(smallDictionary, subtracted, currentWords,max);
                    } else if (max == 0){
                       explore(smallDictionary, subtracted, currentWords,max);
                    }
